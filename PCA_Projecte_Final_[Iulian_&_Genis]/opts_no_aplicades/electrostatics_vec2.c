...
/************/
  ...
  for( x = 0 ; x < grid_size ; x ++ ) {
	...
	for( atoms = 0; atoms < num_charged_atoms - 3; atoms+=4 ) {
	      ...
	      distances[1] = PYTHAGORAS(charged_atoms[atoms+1].coord[0], charged_atoms[atoms].coord[1], charged_atoms[atoms].coord[2], x_centre, y_centre, z_centre);
	      distances[2] = PYTHAGORAS(charged_atoms[atoms+2].coord[0], charged_atoms[atoms].coord[1], charged_atoms[atoms].coord[2], x_centre, y_centre, z_centre);
	      distances[3] = PYTHAGORAS(charged_atoms[atoms+3].coord[0], charged_atoms[atoms].coord[1], charged_atoms[atoms].coord[2], x_centre, y_centre, z_centre);
