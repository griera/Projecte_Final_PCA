...
#define sizeof_Atom_Charged	sizeof( struct Atom_Charged )
...
extern struct Structure translate_static_structure_onto_origin( struct Structure This_Structure, int num_charged_atoms, struct Atom_Charged *charged_atoms ) ;
...
extern void assign_charges_static( struct Structure This_Structure, int *num_charged_atoms ) ;
extern void assign_charges( struct Structure This_Structure ) ;
extern void electric_field( struct Structure This_Structure , float grid_span , int grid_size , fftw_real *grid, int num_charged_atoms, struct Atom_Charged *charged_atoms ) ;
